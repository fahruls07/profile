...
mongoose.connect('mongodb://mongo:27017/resumedb', {
  ...
  const profile = {
    ...
    experiences: [
      ...
      },
      {
        ...
        description: "Configuration and maintenance infrastructure RCTI+ application, implement CI/CD pipeline and maintenance Software Development Live Cycle in any environment (development, staging, and production), research and development new technology, also create documentation.",
        stack: [
          ...
          "Grafana", "Prometheus", "Kong API Gateway", "CloudFlare", "Kafka", "Redis", "Ansible", "Jfrog-Artifactory", "terraform",
          "shell scripting", "Python", "Bash Scripting", "NGINX"
        ],
        responsibilities: [
  ...
  const articles = [
    {
      title: "Getting Started with Kubernetes for DevOps",
      slug: "kubernetes-for-devops",
      excerpt: "Learn the basics of Kubernetes and why it's essential for modern DevOps practices.",
      content: `
        Kubernetes has become the backbone of modern DevOps pipelines. 
        In this article, we'll cover the fundamental concepts you need to understand:
        - What is Kubernetes
        - Pods, Deployments, and Services
        - Scaling and Load Balancing
        - Monitoring with Prometheus and Grafana
        - CI/CD integration with Jenkins and ArgoCD
      `
    },
    {
      title: "Optimizing CI/CD Pipelines with Jenkins and Terraform",
      slug: "cicd-jenkins-terraform",
      excerpt: "How to automate infrastructure and deployment pipelines using Jenkins and Terraform.",
      content: `
        CI/CD pipelines are at the heart of DevOps. 
        Here's how you can optimize yours with Jenkins and Terraform:
  ...
  return Promise.all([
    Profile.deleteMany({}).then(() => Profile.create(profile)),
    Article.deleteMany({}).then(() => Article.insertMany(articles))
  ]);
}).then(() => {
  console.log('✅ Data seeded (Profile + Articles)');
  process.exit(0);
}).catch(err => {
